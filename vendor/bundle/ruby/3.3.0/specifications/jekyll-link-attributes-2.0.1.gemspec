# -*- encoding: utf-8 -*-
# stub: jekyll-link-attributes 2.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<jekyll>.freeze, [">= 4.0.0".freeze])
  s.add_development_dependency(%q<nokogiri>.freeze, [">= 1.0.0".freeze])
